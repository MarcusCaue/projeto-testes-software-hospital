...
class Main {
  public static void main(String[] args) {
    ...
    Paciente p1 = new Paciente("123.456.789-10", "Jonas", "Rua dos Filósofos Brabos");
    p1.setProcedimento("Alta");
    Paciente p2 = new Paciente("987.654.321-09", "Amanda", "Rua dos Filósofos Brabos");
    p2.setProcedimento("Fila de Espera");
    Paciente p3 = new Paciente("121.343.565-90", "Kleito", "Rua dos Filósofos Brabos");
